...
public class AdminService {
	...
	public IS4ResGetScheduleTemplates getScheduleTemplates(IS4ReqGetScheduleTemplates request) {		
		...
		if(!request.getPermissionType().contentEquals("ADMIN")) {
			...
			log.error("[" + currentMethodName + "]]]aaadddgrgtrrfewfewddzztuzgtrgfdgfdhtrhtrhrtfdsfdsggtrgrergrzthzrfedsfeddfff] - " + callId + " - " + response.toString() + " - " + request.getPermissionType() + " - " +"\n");
			return response;
		}
